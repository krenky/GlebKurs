...
namespace GlebKurs.Context
{
    public class CheContext: DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=chedb;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Manager>().HasData(
                new Manager[]
                {
                    new Manager() {Id=1, Name = "Чепурнов Виталий", Fillial = Fillial.che.ToString()}
                });
